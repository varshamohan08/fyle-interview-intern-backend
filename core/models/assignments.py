...
class Assignment(db.Model):
    ...
    def upsert(cls, assignment_new: 'Assignment'):
        if assignment_new.id is not None:
            ...
            assertions.assert_valid(assignment.content is None, 'assignment with empty content cannot be submitted')
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.principal_id:
            assertions.assert_valid(assignment.state is not AssignmentStateEnum.DRAFT, 'Draft assignments cannot be graded')
        else:
